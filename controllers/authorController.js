...
exports.author_update_post = [
    //validate fields.
    body('first_name', 'First name must not be empty.').trim().isLength({
        min: 1
    }),
    body('family_name', 'Family name must not be empty.').trim().isLength({
        min: 1
    }),
    body('date_of_birth', 'Invalid date of birth').optional({
        checkFalsy: true
    }).isISO8601(),
    body('date_of death', 'Invalid date of death').optional({
        checkFalsy: true
    }).isISO8601(),
    ...
    (req, res, next) => {
        ...
        //Create an author with escaped/trimed data and an old id.
        var author = new Author({
            first_name: req.body.first_name,
            family_name: req.body.family_name,
            date_of_birth: req.body.date_of_birth,
